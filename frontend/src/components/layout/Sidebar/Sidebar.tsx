...
export const Sidebar = (): FunctionComponent => {
	return (
		<div
			className="sidebar w-1/6 h-screen flex flex-col fixed bottom-0 py-6 px-8 left-0 bg-main-10 rounded-tr-2xl rounded-br-2xl shadow-md z-50 gap-8"
			id="sidebar"
		>
			...
			<div className="flex flex-col gap-4">
				...
				<ul className="flex flex-col gap-3 pl-3">
					<li className="text-neutral-05 text-xl font-medium">
						<Link to="/youtube-downloader">video downloader</Link>
					</li>
					<li className="text-neutral-05 text-xl font-medium">
						<Link to="/youtube-downloader?info=tags">tag explorer</Link>
					</li>
				</ul>
			</div>
		</div>
